<template>
  <div>
    ...
    <div class="min-h-screen bg-coral">
      <nav class="bg-primary border-b border-gray-100">
        <!-- Primary Navigation Menu -->
        <div class="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8 py-5 text-white">
            ...
            <div class="flex">
              ...
              <div class="hidden space-x-8 sm:-my-px sm:ml-10 sm:flex">
                ...
                <jet-nav-link
                  ...
                  v-if="$page.props.user.role.id === 1 && $page.props.auth.business.id === 1"
                >
                  Usuarios
                </jet-nav-link>
                <jet-nav-link
        ...
        >
          ...
          <div class="pt-4 pb-1 border-t border-gray-200">
            <div class="flex items-center px-4">
              ...
              <div>
                <div class="font-medium text-base text-coral">
                  {{ $page.props.user.name }}
                </div>
                <div class="font-medium text-sm text-coral">
      ...
      <!-- Page Heading -->
      <header class="bg-transparent text-center" v-if="$slots.header">
