                ...
                <div class="w-full flex justify-between flex-wrap">
                    ...
                    <div class="w-full p-4">
                        <div class="w-full flex mb-2">
                            <div class="w-2/5">Codigo :</div>
                            <div class="w-1/5">
                                {{ document.codigo }}
                            </div>
                        </div>
                        <div class="w-full flex mb-2">
                            <div class="w-2/5">Fecha de Solicitud :</div>
                            <div class="w-1/5">
                                {{ document.created_at }}
                            </div>
                        </div>
                        <div class="w-full flex mb-2">
                            <div class="w-2/5">Revisores :</div>
                            <div class="w-1/5">
                                <div
...
export default {
    ...
    setup(props) {
        ...
        const submitForm = async () => {
            form.post(
                route("document.contract.finalize", {
