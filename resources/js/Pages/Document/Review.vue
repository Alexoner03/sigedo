...
<template>
    <app-layout>
        <template #header>
            ...
            <p class="py-4">Tienes un documento para tu revisión</p>
        </template>
                ...
                <div class="w-full flex justify-between flex-wrap">
                    ...
                    <div class="w-full p-4">
                        ...
                        <div class="inline-flex items-center mr-4">
                            <input id="radio1" type="radio" name="obs" class="hidden" />
                            <label for="radio1" class="flex items-center cursor-pointer text-base">
                                Si
                                <span class="w-5 h-5 inline-block ml-2 rounded-full border border-black flex-no-shrink"></span>
                            </label>
                        </div>

                        <div class="inline-flex items-center">
                            <input id="radio2" type="radio" name="obs" class="hidden" />
                    ...
                    <div class="w-full p-4">
                        <p class="mb-2">Carga el documento con tus observaciones</p>
                        <jet-label
                            for="file"
                    ...
                    <div class="w-full py-4 flex justify-center">
                        <jet-button class="text-lg" @click="toggleModalSuccess" disabled>Aprobar Documento</jet-button>
                    </div>
                </div>
            </div>
        </div>
